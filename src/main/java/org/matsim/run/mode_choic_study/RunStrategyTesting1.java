...
public class RunStrategyTesting1 implements MATSimAppCommand {
    ...
    public static void main(String[] args) {
        new RunStrategyTesting1().execute(args);
    }
    ...
    public Integer call() throws Exception {
        ...
        for (double delta : deltas) {
            ...
            // re-planning
            config.replanning().addStrategySettings(new ReplanningConfigGroup.StrategySettings().setStrategyName(DefaultPlanStrategiesModule.DefaultSelector.BestScore).setWeight(0.8));
            config.replanning().addStrategySettings(new ReplanningConfigGroup.StrategySettings().setStrategyName(DefaultPlanStrategiesModule.DefaultSelector.SelectRandom).setWeight(0.1));
